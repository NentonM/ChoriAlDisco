...
class CompraGamerSpider(scrapy.Spider):
    ...
    def parse_json(self, response):
        raw_json = response.body # No tengo ni idea de porque es .body, creo que sin el funcionaria
    ...
    def parse_school(self, response):
        ...
        ProductoItem["nombre"] = {"nombre" : data[0]["nombre"]},
        ProductoItem["precio"] = {"precio" : data[0]["precioEspecial"]} ,
        ProductoItem["pnEan"] = {"pnEan" : data[0]["codigo_principal"]},
        ProductoItem["id"] = {"id" :data[0]["id_producto"]},
        yield ProductoItem
...
# yield {
#            ProductoItem["nombre"]: data[0]["nombre"],
#            ProductoItem["precio"]:  data[0]["precioEspecial"],
#            ProductoItem["pnEan"]: data[0]["codigo_principal"],
#            ProductoItem["id"]: data[0]["id_producto"],
#        }
#
#
#
