...
class MexxCrawler(CrawlSpider):
    ...
    def parse_items(self, response):
        item = ItemLoader(items(), response)
        item.add_xpath('producto', '//h1[contains(@class,"title")]/text()')
        item.add_xpath('precio', '//h2/b[2]/text()')
        item.add_xpath('pnEan', '//p[contains(b,"P/N")]/text()')
        item.add_xpath('pnEan', '//p[contains(b,"PN")]/text()')
        item.add_xpath('pnEan', '//p[contains(b,"EAN")]/text()')
